<template>
	<view class="wrap">
		...
		<view class="content">
			...
			<input class="u-border-bottom u-m-b-40" type="password" v-model="password" placeholder="请输入密码" :focus="isFocus" confirm-type="done" @confirm="submit"/>
			...
			this.submitBtn=true
				...
				try{
					...
					setTimeout(()=>{
						...
						this.$u.route({type:"reLaunch",url})
					},1500)
